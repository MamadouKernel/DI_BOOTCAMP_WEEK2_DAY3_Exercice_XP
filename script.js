...
//5. Écrivez du code pour faire une copie du people tableau à l'aide de la slice méthode.
...
// const NomDeuxLocat = building['nameOfTenants'][1];
// const NbPieceSeconLoca = building['numberOfRoomsAndRent'][NomDeuxLocat][0];
// console.log(`${NomDeuxLocat} has ${NbPieceSeconLoca} rooms in their apartment.`);
